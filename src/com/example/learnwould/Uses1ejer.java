...
public class Uses1ejer extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_uses1ejer);
    		 ...
    		 switch ( leer ) {
    	      case 1:
    	    	     ...
    	    	     mp.start();
    	    	  	...
    	    	  	Ima4 = (ImageView)findViewById(R.id.imause4);
  	    		     Ima4.setImageDrawable(drawable);
  	    		    btncaliificar.setText(R.string.btnNext);
    	           break;
    	        
    	      default:
    	    	  Intent intent = new Intent();
                  intent.setClass(Uses1ejer.this,Uses2ejer.class);
