...
public class Uses5ejer extends Activity implements OnClickListener {
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.activity_uses5ejer);
		 ...
		 switch ( leer ) {
	      case 1:
	    	     ...
	    	     mp.start();
	    	  	...
	    	  	Ima8 = (ImageView)findViewById(R.id.imause8);
	    		     Ima8.setImageDrawable(drawable);
	    		    btncaliificar.setText(R.string.btnNext);
	           break;
	        
	      default:
	    	  Intent intent = new Intent();
              intent.setClass(Uses5ejer.this,Uses6ejer.class);
