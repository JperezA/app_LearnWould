...
public class Uses3ejer extends Activity implements OnClickListener {
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.activity_uses3ejer);
		 ...
		 switch ( leer ) {
	      case 1:
	    	     ...
	    	     mp.start();
	    	  	...
	    	  	Ima6 = (ImageView)findViewById(R.id.imause6);
	    		     Ima6.setImageDrawable(drawable);
	    		    btncaliificar.setText(R.string.btnNext);
	           break;
	        
	      default:
	    	  Intent intent = new Intent();
              intent.setClass(Uses3ejer.this,Uses4ejer.class);
