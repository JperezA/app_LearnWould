...
public class Uses2ejer extends Activity implements OnClickListener  {
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.activity_uses2ejer);
		 ...
		 switch ( leer ) {
	      case 1:
	    	     ...
	    	     mp.start();
	    	  	...
	    	  	Ima5 = (ImageView)findViewById(R.id.imause5);
	    		     Ima5.setImageDrawable(drawable);
	    		    btncaliificar.setText(R.string.btnNext);
	           break;
	        
	      default:
	    	  Intent intent = new Intent();
              intent.setClass(Uses2ejer.this,Uses3ejer.class);
